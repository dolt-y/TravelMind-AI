...
const zh = {
  ...
  inspiration: { eyebrow: '旅行灵感', title: '从一种旅行感受开始', copy: '从海岸到山川，选择心动目的地，开启下一段旅程。', use: '使用这个目的地' },
  ...
  plan: { eyebrow: '规划新的旅程', title: '说说你的出行安排', copy: '告诉我们时间、人数和偏好，轻松生成每日行程。', pipelineTitle: '从灵感到每日行程' },
  ...
  results: { saved: '完整旅行计划', title: '{{city}}行程', summary: '{{start}} 至 {{end}} · 共 {{days}} 天', retry: '重新规划', notices: '行程提醒', itineraryEyebrow: '每日安排', itinerary: '你的逐日行程', dayCount: '{{count}} 天', day: '第 {{day}} 天', transferDay: '城市移动日', routes: '地点间路线', meals: '用餐建议', stay: '当晚住宿', advice: '行前建议', mealTypes: { breakfast: '早餐', lunch: '午餐', dinner: '晚餐', snack: '加餐' }, favorite: '收藏地点', unfavorite: '取消收藏', reservation: '建议预约', addressPending: '地点地址暂未完善', hotelEmpty: '暂时没有合适的住宿信息', emptyTitle: '还没有旅行结果', emptyCopy: '先填写出行需求，生成你的第一份完整行程。', start: '开始规划' },
  tripVisuals: {
  ...
  library: { eyebrow: '我的行程', title: '旅行计划', emptyTitle: '还没有行程', emptyCopy: '完成规划后会保存在这里。', start: '开始规划' },
  libraryHistory: { count: '共 {{count}} 个行程', summary: '已保存 {{total}} 个行程', loading: '正在读取你的行程', loadFailed: '暂时无法读取行程，请稍后重试。', retry: '重新加载', days: '{{count}} 天', travelers: '{{count}} 人', created: '{{date}} 创建', openNamed: '查看 {{city}} 行程', openFailed: '暂时无法打开这个行程，请重新尝试。', pagination: '行程分页', pageStatus: '第 {{page}} / {{totalPages}} 页', pageLabel: '第 {{page}} 页', previous: '上一页', next: '下一页' },
  settings: { title: '账户设置', language: '界面语言', languageCopy: '选择你习惯的语言' },
  xhsAccount: {
    authRequired: '登录小红书后继续本次规划。',
    account: { eyebrow: '账号连接', title: '登录小红书', copy: '选择登录方式，获取真实旅行灵感。' },
    login: { method: '登录方式', qrcode: '二维码', phone: '手机号', qrAlt: '小红书内容账号登录二维码', qrReady: '生成二维码后使用小红书扫码', qrStart: '生成二维码', qrRestart: '重新生成', zone: '区号', phoneNumber: '手机号码', code: '验证码', codePlaceholder: '输入短信验证码', sendCode: '发送验证码', verify: '验证并登录', cookieLabel: 'Cookie', cookieNote: '登录状态将安全保存在当前浏览器。', cookieSubmit: '验证 Cookie', currentUser: '当前账号：{{name}}', continuePlanning: '返回并重新规划' },
    ...
    logout: { title: '退出登录', copy: '清除当前浏览器的登录状态', action: '退出账号', confirm: '确定退出当前账号吗？', success: '已退出登录' },
...
const en = {
  ...
  inspiration: { eyebrow: 'INSPIRATION', title: 'Start with a feeling', copy: 'Choose a place that moves you, then turn it into a journey.', use: 'Use this destination' },
  ...
  plan: { eyebrow: 'PLAN A NEW JOURNEY', title: 'Share your travel details', copy: 'Add your dates and preferences to shape each day.', pipelineTitle: 'From inspiration to itinerary' },
  ...
  libraryHistory: { count: '{{count}} trips', summary: '{{total}} saved trips', loading: 'Loading your trips', loadFailed: 'Your trips could not be loaded. Please try again.', retry: 'Reload', days: '{{count}} days', travelers: '{{count}} travelers', created: 'Created {{date}}', openNamed: 'View {{city}} trip', openFailed: 'This trip could not be opened. Please try again.', pagination: 'Trip pages', pageStatus: 'Page {{page}} of {{totalPages}}', pageLabel: 'Page {{page}}', previous: 'Previous page', next: 'Next page' },
  settings: { title: 'Preferences and account', language: 'Interface language', languageCopy: 'Change navigation and page copy' },
  xhsAccount: {
    authRequired: 'Sign in to Xiaohongshu to continue this plan.',
    account: { eyebrow: 'ACCOUNT CONNECTION', title: 'Connect Xiaohongshu', copy: 'Choose a sign-in method for live travel inspiration.' },
    login: { method: 'Login method', qrcode: 'QR code', phone: 'Phone', qrAlt: 'Xiaohongshu content account login QR code', qrReady: 'Generate a code and scan it with Xiaohongshu', qrStart: 'Generate QR code', qrRestart: 'Generate again', zone: 'Code', phoneNumber: 'Phone number', code: 'Verification code', codePlaceholder: 'Enter SMS code', sendCode: 'Send code', verify: 'Verify and log in', cookieLabel: 'Cookie', cookieNote: 'Your session stays securely in this browser.', cookieSubmit: 'Verify Cookie', currentUser: 'Current account: {{name}}', continuePlanning: 'Return and retry plan' },
...
const ja = {
  ...
  inspiration: { eyebrow: '旅の発見', title: '旅の気分から始めよう', copy: '心ひかれる場所を選び、次の旅を始めましょう。', use: 'この目的地を使う' },
  ...
  plan: { eyebrow: '新しい旅を計画', title: '旅行の予定を教えてください', copy: '日程、人数、好みから毎日の旅程を整えます。', pipelineTitle: '発見から日別プランへ' },
  ...
  results: { saved: '旅行プラン', title: '{{city}}の旅程', summary: '{{start}} から {{end}} · {{days}} 日間', retry: 'もう一度計画', notices: '旅程のお知らせ', itineraryEyebrow: '日別スケジュール', itinerary: 'あなたの旅程', dayCount: '{{count}} 日間', day: '{{day}} 日目', transferDay: '都市移動日', routes: '場所間のルート', meals: '食事の提案', stay: '今夜の宿泊', advice: '出発前のアドバイス', mealTypes: { breakfast: '朝食', lunch: '昼食', dinner: '夕食', snack: '軽食' }, favorite: 'お気に入り', unfavorite: 'お気に入りを解除', reservation: '予約推奨', addressPending: '住所は準備中です', hotelEmpty: '宿泊情報はまだありません', emptyTitle: '旅程がありません', emptyCopy: '旅行条件を入力して最初の旅程を作りましょう。', start: '計画を始める' },
  tripVisuals: {
  ...
  libraryHistory: { count: '{{count}} 件の旅程', summary: '{{total}} 件の旅程を保存済み', loading: '旅程を読み込み中', loadFailed: '旅程を読み込めませんでした。しばらくしてからお試しください。', retry: '再読み込み', days: '{{count}} 日間', travelers: '{{count}} 人', created: '{{date}} に作成', openNamed: '{{city}} の旅程を見る', openFailed: 'この旅程を開けませんでした。もう一度お試しください。', pagination: '旅程ページ', pageStatus: '{{page}} / {{totalPages}} ページ', pageLabel: '{{page}} ページ', previous: '前のページ', next: '次のページ' },
  settings: { title: '好みとアカウント', language: '表示言語', languageCopy: 'ナビゲーションとページの言語を変更' },
  xhsAccount: {
    authRequired: '小紅書にログインして計画を続けてください。',
    account: { eyebrow: 'アカウント接続', title: '小紅書アカウントを接続', copy: 'ログイン方法を選び、リアルな旅のヒントを取得します。' },
    login: { method: 'ログイン方法', qrcode: 'QR コード', phone: '電話番号', qrAlt: '小紅書コンテンツアカウントのログイン QR コード', qrReady: 'QR コードを生成して小紅書でスキャン', qrStart: 'QR コードを生成', qrRestart: '再生成', zone: '国番号', phoneNumber: '電話番号', code: '確認コード', codePlaceholder: 'SMS コードを入力', sendCode: 'コードを送信', verify: '確認してログイン', cookieLabel: 'Cookie', cookieNote: 'ログイン状態はこのブラウザに安全に保存されます。', cookieSubmit: 'Cookie を確認', currentUser: '現在のアカウント：{{name}}', continuePlanning: '戻って再計画する' },
